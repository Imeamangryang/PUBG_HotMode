...
public:
	...
	void NotifyPlayerStateReady(class ABG_PlayerState* InPS);
...
private: // --- State binding ---
	void BindToPlayerState(class ABG_PlayerState* InPS);
	void UnbindFromPlayerState();

	UFUNCTION()
	void ReceiveHealthChanged(float NewHealth, float MaxHealth, bool bIsDead);
...
private: // --- Cached attribute values ---
	...
	UPROPERTY()
	TWeakObjectPtr<class ABG_PlayerState> BoundedPlayerState;
};
